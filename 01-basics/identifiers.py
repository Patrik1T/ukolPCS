...
x = 0
# global = 1 -je klíčové slovo v Pythonu a nemůže být použito jako název proměnné
global1 = 1
PI = 3.14
city = "Opava"
# hilda@sspu-opava.cz = 'Hilda Dokonalá' - název proměnné nesmí obsahovat speciální znaky jako [@-.], jen čísla, písmena a _
hildasspu_opavacz = 'Hilda Dokonalá'
password2 = 'TajneHeslo'
# 007agent = 'James Bond' - proměnná nemůže začínat číslicí v Pythonu
agent007 = 'James Bond'
