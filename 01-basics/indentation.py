...
def najdi_prvocisla(maximalnicislo):
    """
    Tato funkce najde všechna prvočísla 
    menší než zadané maximální číslo.
    
    """
    prvocisla = []

    for cislo in range(2, maximalnicislo):
        jeprvocislo = True
...
maximalnicislo = 20
print(f"Prvočísla menší než {maximalnicislo}: {najdi_prvocisla(maximalnicislo)}")
